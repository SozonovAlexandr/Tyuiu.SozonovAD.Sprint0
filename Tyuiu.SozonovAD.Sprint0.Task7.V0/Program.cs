...
using Tyuiu.SozonovAD.Sprint0.Task7.V0.Lib;

namespace Tyuiu.SozonovAD.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #0 | Выполнил: Созонов А. Д. | ПКТ6-25-1";
            ...
            {
                Console.WriteLine("Ошибка! Исходные массивы имют разное количество элементов");
